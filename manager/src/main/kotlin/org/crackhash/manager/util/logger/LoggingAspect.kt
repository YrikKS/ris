package org.crackhash.manager.util.logger
...
class LoggingAspect {
    ...
    @Pointcut("@annotation(org.crackhash.manager.util.logger.LogBefore)")
    fun logBeforePointcut() {}

    @Pointcut("@annotation(org.crackhash.manager.util.logger.LogAfter)")
